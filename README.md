...
- python-markdownify: ([homepage](http://github.com/matthewwithanm/python-markdownify)) made in python
...
- apache-commons-net: ([homepage](https://github.com/apache/commons-net)) made in jvm
- config-validator: ([homepage](https://github.com/GoogleCloudPlatform/config-validator/)) made in go
...
- scikit-learn: ([homepage](https://github.com/scikit-learn/scikit-learn)) made in python
...
- cryptofuzz: ([homepage](https://github.com/guidovranken/cryptofuzz)) made in c++
- libraw: ([homepage](https://www.libraw.org/)) made in c++
- xnu: ([homepage](https://opensource.apple.com/)) made in c
- kafka: ([homepage](https://github.com/confluentinc/confluent-kafka-python)) made in python
- caddy: ([homepage](https://caddyserver.com/)) made in go
- unirest-java: ([homepage](https://github.com/Mashape/unirest-java)) made in jvm
...
- twelve-monkeys: ([homepage](https://github.com/haraldk/TwelveMonkeys)) made in jvm
...
- http-pattern-matcher: ([homepage](https://github.com/google/http_pattern_matcher)) made in c++
...
- opencensus-go: ([homepage](https://github.com/census-instrumentation/opencensus-go)) made in go
...
- python-future: ([homepage](https://github.com/PythonCharmers/python-future)) made in python
...
- apache-axis2: ([homepage](https://axis.apache.org/axis2/java/core/)) made in jvm
- pyrsistent: ([homepage](https://github.com/tobgu/pyrsistent)) made in python
- golang-protobuf: ([homepage](https://github.com/protocolbuffers/protobuf-go)) made in go
- lima: ([homepage](https://lima-vm.io/)) made in go
- botocore: ([homepage](https://github.com/boto/botocore)) made in python
- libplist: ([homepage](https://github.com/libimobiledevice/libplist)) made in c++
- trust-dns: ([homepage](https://github.com/hickory-dns/hickory-dns)) made in rust
- mako: ([homepage](https://github.com/sqlalchemy/mako)) made in python
- openpyxl: ([homepage](https://foss.heptapod.net/openpyxl/openpyxl)) made in python
- promise-polyfill: ([homepage](https://github.com/taylorhakes/promise-polyfill)) made in javascript
- bottleneck: ([homepage](https://github.com/pydata/bottleneck)) made in python
- metadata-extractor: ([homepage](https://github.com/drewnoakes/metadata-extractor)) made in jvm
- hdf5: ([homepage](https://www.hdfgroup.org/solutions/hdf5/)) made in c
- aniso8601: ([homepage](https://bitbucket.org/nielsenb/aniso8601)) made in python
...
- mdbook-i18n-helpers: ([homepage](https://github.com/google/mdbook-i18n-helpers)) made in rust
- g-py-crc32c: ([homepage](https://github.com/googleapis/python-crc32c)) made in python
- rekor: ([homepage](https://sigstore.dev)) made in go
- g-api-auth-library-python: ([homepage](https://github.com/googleapis/google-auth-library-python)) made in python
- spicy: ([homepage](https://docs.zeek.org/projects/spicy/en/latest/)) made in c++
...
- protocompile: ([homepage](https://github.com/bufbuild/protocompile)) made in go
...
- python-markdown: ([homepage](https://github.com/python-markdown/markdown)) made in python
- json5format: ([homepage](https://crates.io/crates/json5format)) made in rust
- proto-plus-python: ([homepage](https://github.com/googleapis/proto-plus-python)) made in python
- toml: ([homepage](https://github.com/uiri/toml/)) made in python
- arduinojson: ([homepage](https://github.com/bblanchon/ArduinoJson)) made in c++
- oniguruma: ([homepage](https://github.com/kkos/oniguruma)) made in c
- libsass: ([homepage](http://libsass.org/)) made in c++
- adal: ([homepage](https://github.com/AzureAD/azure-activedirectory-library-for-python)) made in python
...
- apache-commons-text: ([homepage](https://github.com/apache/commons-text/)) made in jvm
- compress: ([homepage](https://github.com/klauspost/compress)) made in go
- python-nvd3: ([homepage](https://github.com/areski/python-nvd3)) made in python
...
- openapi-schema-validator: ([homepage](https://github.com/p1c2u/openapi-schema-validator)) made in python
...
- spring-amqp: ([homepage](https://github.com/spring-projects/spring-amqp.git)) made in jvm
...
- ngolo-fuzzing-x: ([homepage]('https://github.com/catenacyber/ngolo-fuzzing)) made in go
- weechat: ([homepage](https://github.com/weechat/weechat)) made in undefined
- sigstore: ([homepage](https://sigstore.dev)) made in go
- spring-cloud-sleuth-brave: ([homepage](https://spring.io/projects/spring-cloud-sleuth)) made in jvm
- typst: ([homepage](https://typst.app/)) made in rust
- librawspeed: ([homepage](https://github.com/darktable-org/rawspeed)) made in c++
- wasm3: ([homepage](https://github.com/wasm3/wasm3)) made in c
- xmlunit: ([homepage](https://github.com/xmlunit/xmlunit)) made in jvm
- libyuv: ([homepage](https://chromium.googlesource.com/libyuv/libyuv/)) made in c++
- cryptography: ([homepage](https://github.com/pyca/cryptography)) made in python
...
- swagger-core: ([homepage](https://github.com/swagger-api/swagger-core)) made in jvm
- filelock: ([homepage](https://github.com/google/oss-fuzz/pull/8244)) made in python
...
- spring-cloud-netflix: ([homepage](https://cloud.spring.io/spring-cloud-netflix/reference/html/)) made in jvm
...
- graphql-java: ([homepage](https://github.com/graphql-java/graphql-java)) made in jvm
...
- boringssl: ([homepage](https://boringssl.googlesource.com/boringssl/)) made in c++
...
- tensorflow-serving: ([homepage](https://github.com/tensorflow/serving)) made in c++
...
- more-itertools: ([homepage](https://github.com/more-itertools/more-itertools)) made in python
- tesseract-ocr: ([homepage](https://github.com/tesseract-ocr/tesseract)) made in c++
...
- docker-client: ([homepage](https://github.com/spotify/docker-client)) made in jvm
...
- systemd: ([homepage](https://freedesktop.org/wiki/Software/systemd/)) made in c++
- rust-regex: ([homepage](https://github.com/rust-lang/regex)) made in rust
- exiv2: ([homepage](https://www.exiv2.org)) made in c++
- hikaricp: ([homepage](https://github.com/brettwooldridge/HikariCP)) made in jvm
- opencsv: ([homepage](https://sourceforge.net/projects/opencsv/)) made in jvm
- async-http-client: ([homepage](https://github.com/AsyncHttpClient/async-http-client/)) made in jvm
- crosvm: ([homepage](http://crosvm.dev)) made in rust
- xmltodict: ([homepage](https://github.com/martinblech/xmltodict)) made in python
- pigweed: ([homepage](https://pigweed.dev/)) made in c++
- roaring-bitmap: ([homepage](https://github.com/RoaringBitmap/RoaringBitmap)) made in jvm
...
- double-conversion: ([homepage](https://github.com/google/double-conversion)) made in c++
- spring-ldap: ([homepage](https://github.com/spring-projects/spring-ldap.git)) made in jvm
- spring-data-keyvalue: ([homepage](https://docs.spring.io/spring-data/keyvalue/docs/current/reference/html/)) made in jvm
- jupyter_server: ([homepage](https://github.com/jupyter-server/jupyter_server)) made in python
...
- python-hyperlink: ([homepage](https://github.com/python-hyper/hyperlink)) made in python
...
- mandelbulber: ([homepage](https://github.com/buddhi1980/mandelbulber2/)) made in undefined
- bearssl: ([homepage](https://bearssl.org/)) made in c++
- libpng-proto: ([homepage](http://www.libpng.org/pub/png/libpng.html)) made in c++
- redis-py: ([homepage](https://github.com/redis/redis-py)) made in python
- oss-fuzz-example: ([homepage](https://github.com/AdaLogics/oss-fuzz-example)) made in c
- g-api-secret-manager: ([homepage](https://github.com/googleapis/python-secret-manager)) made in python
- spring-boot: ([homepage](https://github.com/spring-projects/spring-boot)) made in jvm
...
- xmlpull: ([homepage](https://github.com/xmlpull-org/xmlpull-api-v1)) made in jvm
...
- apache-commons-logging: ([homepage](https://commons.apache.org/proper/commons-collections/)) made in jvm
- python-pathspec: ([homepage](https://github.com/cpburnz/python-pathspec)) made in python
- fonttools: ([homepage](https://github.com/behdad/fonttools)) made in python
- json-simple: ([homepage](https://github.com/fangyidong/json-simple)) made in jvm
- libdwarf: ([homepage](https://www.prevanders.net/dwarf.html)) made in c
- zipp: ([homepage](https://github.com/jaraco/zipp)) made in python
- fuzzing-puzzles: ([homepage](https://github.com/google/fuzzer-test-suite)) made in c++
...
- realm-core: ([homepage](https://github.com/realm/realm-core)) made in undefined
- bincode: ([homepage](https://github.com/bincode-org/bincode)) made in rust
- go-attestation: ([homepage](https://github.com/google/go-attestation)) made in go
...
- python-tabulate: ([homepage](https://github.com/astanin/python-tabulate)) made in python
...
- g-api-python-firestore: ([homepage](https://github.com/googleapis/python-firestore)) made in python
- python-graphviz: ([homepage](https://github.com/xflr6/graphviz)) made in python
- kubeedge: ([homepage](https://kubeedge.io/en/)) made in go
- p11-kit: ([homepage](https://p11-glue.github.io/p11-glue/p11-kit.html)) made in c
...
- spring-framework: ([homepage](https://github.com/spring-projects/spring-framework)) made in jvm
- go-sftp: ([homepage](https://github.com/pkg/sftp)) made in go
- cgif: ([homepage](https://github.com/dloebl/cgif)) made in c
- pikepdf: ([homepage](https://pikepdf.readthedocs.io/en/latest/index.html)) made in python
- markdown-it-py: ([homepage](https://github.com/executablebooks/markdown-it-py)) made in python
- rhino: ([homepage](https://github.com/mozilla/rhino)) made in jvm
- rocksdb: ([homepage](https://github.com/facebook/rocksdb)) made in c++
- stax: ([homepage](https://docs.oracle.com/javase/8/docs/api/index.html?javax/xml/stream/package-summary.html)) made in jvm
...
- jsqlparser: ([homepage](https://jsqlparser.github.io/JSqlParser/index.html)) made in jvm
...
- brotli-java: ([homepage](https://github.com/google/brotli/tree/master/java)) made in jvm
...
- wamr: ([homepage](https://github.com/bytecodealliance/wasm-micro-runtime)) made in c
...
- eigen: ([homepage](http://eigen.tuxfamily.org/index.php?title=Main_Page)) made in c++
- gnupg: ([homepage](https://www.gnupg.org)) made in c++
- spidermonkey: ([homepage](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/SpiderMonkey)) made in c++
- libtheora: ([homepage](https://www.theora.org/)) made in c++
- msal: ([homepage](https://github.com/AzureAD/microsoft-authentication-library-for-python)) made in python
...
- spirv-tools: ([homepage](https://github.com/KhronosGroup/SPIRV-Tools)) made in c++
- jsonp-api: ([homepage](https://github.com/jakartaee/jsonp-api)) made in jvm
- jboss-logging: ([homepage](https://github.com/jboss-logging/jboss-logging)) made in jvm
- jackson-dataformat-xml: ([homepage](https://github.com/FasterXML/jackson-dataformat-xml)) made in jvm
...
- closure-compiler: ([homepage](https://developers.google.com/closure/compiler/)) made in jvm
- s2opc: ([homepage](https://s2opc.com/)) made in c++
- libcst: ([homepage](https://github.com/instagram/libcst)) made in python
- html5lib-python: ([homepage](https://github.com/html5lib/html5lib-python)) made in python
- jackson-dataformats-binary: ([homepage](https://github.com/FasterXML/jackson-dataformats-binary)) made in jvm
...
- pyxdg: ([homepage](https://freedesktop.org/wiki/Software/pyxdg/)) made in python
- httpcomponents-client: ([homepage](https://github.com/apache/httpcomponents-client)) made in jvm
- json-smart-v2: ([homepage](https://github.com/netplex/json-smart-v2)) made in jvm
- cmake: ([homepage](https://gitlab.kitware.com/cmake/cmake)) made in c
- htslib: ([homepage](https://www.htslib.org/)) made in c++
- tinyusb: Couldn't parse. [View file](https://github.com/google/oss-fuzz/blob/master/projects/tinyusb/project.yaml).
...
- cloud-hypervisor: ([homepage](https://github.com/cloud-hypervisor/cloud-hypervisor)) made in rust
...
- greenmail: ([homepage](https://github.com/greenmail-mail-test/greenmail)) made in jvm
...
- apache-commons-configuration: ([homepage](https://commons.apache.org/proper/commons-configuration/)) made in jvm
...
- g-api-python-bigquery-storage: ([homepage](https://github.com/googleapis/python-bigquery-storage)) made in python
...
- java-uuid-generator: ([homepage](https://github.com/cowtowncoder/java-uuid-generator)) made in jvm
- github_scarecrow: ([homepage](https://github.com/Alan32Liu/github-scarecrow)) made in python
- ogre: ([homepage](https://github.com/OGRECave/ogre)) made in c++
- gc-iam: ([homepage](https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-iam)) made in python
...
- g-api-resource-manager: ([homepage](https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-resource-manager)) made in python
- jsign: ([homepage](https://ebourg.github.io/jsign/)) made in jvm
- distribution: ([homepage](https://github.com/distribution/distribution)) made in go
...
- bazel-rules-fuzzing-test: ([homepage](https://github.com/bazelbuild/rules_fuzzing)) made in c++
- dart: ([homepage](https://dart.dev)) made in c++
- tinyobjloader: ([homepage](https://github.com/tinyobjloader/tinyobjloader)) made in c++
- python-nameparser: ([homepage](https://github.com/derek73/python-nameparser)) made in python
...
- bs4: ([homepage](https://www.crummy.com/software/BeautifulSoup/)) made in python
...
- gitdb: ([homepage](https://github.com/gitpython-developers/gitdb)) made in python
- jflex: ([homepage](https://github.com/jflex-de/jflex)) made in jvm
- pyvex: ([homepage](https://api.angr.io/projects/pyvex/en/latest/api.html)) made in python
...
- sacremoses: ([homepage](https://github.com/alvations/sacremoses)) made in python
- s2geometry: ([homepage](https://github.com/google/s2geometry)) made in c++
- ndpi: ([homepage](https://www.ntop.org/products/deep-packet-inspection/ndpi/)) made in c++
- libzip: ([homepage](https://libzip.org/)) made in c++
- perfetto: ([homepage](https://perfetto.dev)) made in c++
- fontations: ([homepage](https://github.com/googlefonts/fontations)) made in rust
...
- node-xml2js: ([homepage](https://github.com/Leonidas-from-XIV/node-xml2js)) made in javascript
...
- jakarta-mail-api: ([homepage](https://eclipse-ee4j.github.io/mail)) made in jvm
...
- jackson-databind: ([homepage](https://github.com/FasterXML/jackson-databind)) made in jvm
- xerces: ([homepage](https://xerces.apache.org/index.html)) made in jvm
- mysql-connector-j: ([homepage](https://dev.mysql.com/doc/connector-j/8.0/en/)) made in jvm
- vulkan-loader: ([homepage](https://github.com/khronosgroup/Vulkan-Loader)) made in c
- json2avro: ([homepage](https://github.com/allegro/json-avro-converter)) made in jvm
- httpretty: ([homepage](https://github.com/gabrielfalcao/httpretty)) made in python
...
- bazel-rules-fuzzing-test-java: ([homepage](https://github.com/bazelbuild/rules_fuzzing)) made in jvm
...
- easywsclient: ([homepage](https://github.com/dhbaird/easywsclient)) made in c++
- firestore: ([homepage](https://firebase.google.com/docs/firestore/)) made in c++
...
- mrab-regex: ([homepage](https://github.com/mrabarnett/mrab-regex)) made in python
- pako: ([homepage](https://nodeca.github.io/pako/)) made in javascript
- libteken: ([homepage](http://svn.freebsd.org/base/head/sys/teken/)) made in c++
...
- g-api-python-tasks: ([homepage](https://github.com/googleapis/google-cloud-python/tree/main/packages/google-cloud-tasks)) made in python
...
- mbedtls: ([homepage](https://developer.trustedfirmware.org/w/mbed-tls/)) made in c++
...
- spring-shell: ([homepage](http://projects.spring.io/spring-shell/)) made in jvm
- xnnpack: ([homepage](https://github.com/google/XNNPACK)) made in c++
- apache-commons-jxpath: ([homepage](https://github.com/apache/commons-jxpath.git)) made in jvm
- libavif: ([homepage](https://github.com/AOMediaCodec/libavif)) made in c++
- libfdk-aac: ([homepage](https://android.googlesource.com/platform/external/aac/)) made in c++
...
- jwt-verify-lib: ([homepage](https://github.com/google/jwt_verify_lib)) made in c++
- bignum-fuzzer: ([homepage](https://github.com/guidovranken/bignum-fuzzer)) made in c++
- gfwx: ([homepage](http://www.gfwx.org/)) made in c++
- psqlparse: ([homepage](https://github.com/alculquicondor/psqlparse)) made in python
- opencv: ([homepage](https://opencv.org/)) made in c++
- mariadb-connector-j: ([homepage](https://github.com/mariadb-corporation/mariadb-connector-j)) made in jvm
- matplotlib: ([homepage](https://github.com/matplotlib/matplotlib)) made in python
- prost: ([homepage](https://crates.io/crates/prost)) made in rust
- python-ecdsa: ([homepage](https://github.com/tlsfuzzer/python-ecdsa)) made in python
- tyrus: ([homepage](https://github.com/eclipse-ee4j/tyrus)) made in jvm
- sqlite3: ([homepage](https://sqlite.org/)) made in c++
- astc-encoder: ([homepage](https://github.com/ARM-software/astc-encoder)) made in c++
...
- opennavsurf-bag: ([homepage](https://github.com/OpenNavigationSurface/BAG)) made in c++
...
- dateparser: ([homepage](https://dateparser.readthedocs.io/en/latest/)) made in python
...
- typing_extensions: ([homepage](https://github.com/python/typing_extensions)) made in python
- p9: ([homepage](https://github.com/hugelgupf/p9)) made in go
- fastjson: ([homepage](https://github.com/valyala/fastjson)) made in go
- calcite-avatica: ([homepage](https://github.com/apache/calcite-avatica)) made in jvm
...
- libprotobuf-mutator: ([homepage](https://github.com/google/libprotobuf-mutator)) made in c++
- dng_sdk: ([homepage](https://android.googlesource.com/platform/external/dng_sdk/)) made in c++
...
- libcacard: ([homepage](https://gitlab.freedesktop.org/spice/libcacard)) made in c
...
- spidermonkey-ufi: ([homepage](https://searchfox.org/mozilla-central/source/js/src/fuzz-tests/README)) made in c++
...
- sqlparse: ([homepage](https://github.com/andialbrecht/sqlparse)) made in python
- g-api-pubsub: ([homepage](https://github.com/googleapis/python-pubsub)) made in python
- cri-o: ([homepage](https://cri-o.io/)) made in go
- g-py-bigquery: ([homepage](https://github.com/googleapis/python-bigquery)) made in python
- stringtemplate4: ([homepage](https://github.com/antlr/stringtemplate4)) made in jvm
...
- netcdf: ([homepage](https://www.unidata.ucar.edu/software/netcdf/docs/index.html)) made in c++
...
- python-phonenumbers: ([homepage](https://github.com/daviddrysdale/python-phonenumbers)) made in python
...
- esp-v2: ([homepage](https://github.com/GoogleCloudPlatform/esp-v2)) made in c++
- postgresql: ([homepage](https://postgresql.org)) made in c
- myanmar-tools: ([homepage](https://github.com/googlei18n/myanmar-tools/)) made in c++
...
- cbor-java: ([homepage](https://android.googlesource.com/platform/external/cbor-java/+/refs/heads/master)) made in jvm
...
- jackson-modules-java8: ([homepage](https://github.com/FasterXML/jackson-modules-java8)) made in jvm
...
- apache-commons-bcel: ([homepage](https://commons.apache.org/proper/commons-bcel/)) made in jvm
- argcomplete: ([homepage](https://github.com/kislyuk/argcomplete)) made in python
- apache-commons-validator: ([homepage](https://github.com/apache/commons-validator)) made in jvm
- osquery: ([homepage](https://osquery.io)) made in c++
- util-linux: ([homepage](https://github.com/util-linux/util-linux)) made in c
- mdit-py-plugins: ([homepage](https://github.com/executablebooks/mdit-py-plugins)) made in python
...
- kubernetes-cluster-api: ([homepage](https://cluster-api.sigs.k8s.io)) made in go
- md4c: ([homepage](https://github.com/mity/md4c)) made in c
- spice-usbredir: ([homepage](https://www.spice-space.org/usbredir.html)) made in c++
- giflib: ([homepage](http://giflib.sourceforge.net/)) made in c++
- publicsuffix-list: ([homepage](https://github.com/publicsuffix/list)) made in go
...
- muparser: ([homepage](https://beltoforion.de/article.php?a=muparser)) made in c++
...
- json-sanitizer: ([homepage](https://github.com/OWASP/json-sanitizer)) made in jvm
- hibernate-validator: ([homepage](https://github.com/hibernate/hibernate-validator)) made in jvm
...
- protobuf-java: ([homepage](https://developers.google.com/protocol-buffers/)) made in jvm
- go-dns: ([homepage](https://github.com/miekg/dns)) made in go
- uwebsockets: ([homepage](https://github.com/uNetworking/uWebSockets)) made in c++
...
- iniconfig: ([homepage](https://github.com/pytest-dev/iniconfig)) made in python
...
- magic-modules: ([homepage](https://github.com/GoogleCloudPlatform/magic-modules)) made in go
...
- go-containerregistry: ([homepage](https://github.com/google/go-containerregistry)) made in go
- apache-commons-cli: ([homepage](https://commons.apache.org/proper/commons-cli/)) made in jvm
- swift-nio: ([homepage](https://github.com/apple/swift-nio)) made in swift
- eclipse-equinox: ([homepage](https://github.com/eclipse-equinox/equinox)) made in jvm
- textdistance: ([homepage](https://github.com/life4/textdistance)) made in python
- coreutils: ([homepage](http://www.gnu.org/software/coreutils/)) made in undefined
...
- bls-signatures: ([homepage](https://github.com/supranational/blst)) made in c++
- jackson-datatype-joda: ([homepage](https://github.com/FasterXML/jackson-datatype-joda)) made in jvm
...
- starlark-rust: ([homepage](https://github.com/facebookexperimental/starlark-rust/)) made in rust
...
- icalendar: ([homepage](https://icalendar.readthedocs.io/en/latest/)) made in python
...
- filesystem_spec: ([homepage](https://github.com/fsspec/filesystem_spec)) made in python
- ots: ([homepage](https://github.com/khaledhosny/ots)) made in c++
- file: ([homepage](http://www.darwinsys.com/file/)) made in c++
- gcloud-go: ([homepage](https://github.com/googleapis/google-cloud-go)) made in go
...
- python-rison: ([homepage](https://github.com/betodealmeida/python-rison)) made in python
- g-api-auth-httplib2: ([homepage](https://github.com/googleapis/google-auth-library-python-httplib2)) made in python
...
- protobuf-python: ([homepage](https://developers.google.com/protocol-buffers/)) made in python
- g-cloud-logging-py: ([homepage](https://github.com/googleapis/python-logging)) made in python
- g-api-python-client: ([homepage](https://github.com/googleapis/google-api-python-client)) made in python
- rauc: ([homepage](https://rauc.io/)) made in c
- jul-to-slf4j: ([homepage](https://www.slf4j.org/)) made in jvm
- jopt-simple: ([homepage](http://jopt-simple.github.io/jopt-simple/)) made in jvm
...
- g-api-py-api-common-protos: ([homepage](https://github.com/googleapis/python-api-common-protos)) made in python
...
- apache-commons-fileupload: ([homepage](https://commons.apache.org/proper/commons-fileupload/)) made in jvm
- nom: ([homepage](https://github.com/Geal/nom)) made in rust
- closure-library: ([homepage](https://developers.google.com/closure/library/)) made in javascript
- grpc-httpjson-transcoding: ([homepage](https://github.com/grpc-ecosystem/grpc-httpjson-transcoding)) made in c++
- python-fastjsonschema: ([homepage](https://github.com/horejsek/python-fastjsonschema)) made in python
- cyclonedds: ([homepage](https://projects.eclipse.org/projects/iot.cyclonedds)) made in c
- rtpproxy: ([homepage](https://rtpproxy.org/)) made in c
- flate2-rs: ([homepage](https://github.com/rust-lang/flate2-rs)) made in rust
- poppler: Couldn't parse. [View file](https://github.com/google/oss-fuzz/blob/master/projects/poppler/project.yaml).
- mosh: ([homepage](https://mosh.org)) made in c++
- mruby: ([homepage](https://www.mruby.org/)) made in c++
- charset_normalizer: ([homepage](https://github.com/Ousret/charset_normalizer)) made in python
- avahi: ([homepage](https://avahi.org/)) made in c++
- spring-data-mongodb: ([homepage](https://github.com/spring-projects/spring-data-mongodb)) made in jvm
- circl: ([homepage](https://github.com/cloudflare/circl)) made in c++
- jackson-datatypes-collections: ([homepage](https://github.com/FasterXML/jackson-datatypes-collections)) made in jvm
...
- tungstenite-rs: ([homepage](https://crates.io/crates/tungstenite)) made in rust
...
- simplejson: ([homepage](https://github.com/simplejson/simplejson)) made in python
- cras: ([homepage](https://www.chromium.org)) made in rust
- libtsm: ([homepage](https://www.freedesktop.org/wiki/Software/kmscon/libtsm/)) made in c++
- lua: ([homepage](https://www.lua.org/)) made in c
- sqlalchemy: ([homepage](https://www.sqlalchemy.org)) made in python
- protoc-gen-validate: ([homepage](https://github.com/bufbuild/protoc-gen-validate)) made in go
- python-jose: ([homepage](https://github.com/mpdavis/python-jose)) made in python
...
- kimageformats: ([homepage](https://cgit.kde.org/kimageformats.git/)) made in c++
- unicode-rs: ([homepage](http://unicode-rs.github.io/)) made in rust
- javascript-example: ([homepage](https://github.com/CodeIntelligenceTesting/jazzer.js)) made in javascript
- spring-security: ([homepage](https://github.com/spring-projects/spring-security)) made in jvm
- lcms: ([homepage](http://www.littlecms.com/)) made in c++
- urllib3: ([homepage](https://github.com/urllib3/urllib3)) made in python
- librosa: ([homepage](https://librosa.org/doc/latest/index.html)) made in python
- swift-protobuf: ([homepage](https://github.com/apple/swift-protobuf)) made in swift
- g-api-resumable-media-python: ([homepage](https://github.com/googleapis/google-resumable-media-python)) made in python
- mpv: ([homepage](https://github.com/mpv-player/mpv)) made in c
- xerces-c: ([homepage](https://xerces.apache.org/)) made in c++
- g-apis-py-api-core: ([homepage](https://github.com/googleapis/python-api-core)) made in python
- libtiff: ([homepage](http://www.libtiff.org)) made in c++
- spring-cloud-commons: ([homepage](https://github.com/spring-cloud/spring-cloud-commons)) made in jvm
- java-xmlbuilder: ([homepage](https://github.com/jmurty/java-xmlbuilder)) made in jvm
...
- univocity-parsers: ([homepage](https://github.com/univocity/univocity-parsers/)) made in jvm
- wxwidgets: ([homepage](https://www.wxwidgets.org/)) made in c++
- stack_data: ([homepage](https://github.com/alexmojaki/stack_data)) made in python
...
- nss: ([homepage](https://developer.mozilla.org/en-US/docs/Mozilla/Projects/NSS)) made in c++
...
- jsoncpp: ([homepage](https://github.com/open-source-parsers/jsoncpp/)) made in c++
...
- gcloud-error-py: ([homepage](https://github.com/googleapis/python-error-reporting)) made in python
- jsc: ([homepage](https://webkit.org/)) made in c++
- spring-retry: ([homepage](https://ci.spring.io/teams/spring-retry/pipelines/spring-retry-2.0.x)) made in jvm
- configparser: ([homepage](https://github.com/jaraco/configparser/)) made in python
- yamlbeans: ([homepage](https://github.com/EsotericSoftware/yamlbeans/)) made in jvm
...
- hdrhistogram: ([homepage](https://github.com/HdrHistogram/HdrHistogram.git)) made in jvm
- zeek: ([homepage](https://www.zeek.org)) made in c++
- nats: ([homepage](https://github.com/nats-io/nats-server)) made in go
- spring-cloud-config: ([homepage](https://docs.spring.io/spring-cloud-config/docs/current/reference/html/)) made in jvm
- typescript-example: ([homepage](https://github.com/CodeIntelligenceTesting/jazzer.js)) made in javascript
- apache-logging-log4cxx: ([homepage](https://logging.apache.org/log4cxx)) made in c++
...
- g-api-python-cloud-core: ([homepage](https://github.com/googleapis/python-cloud-core)) made in python
- libmicrohttpd: ([homepage](https://www.gnu.org/s/libmicrohttpd/)) made in undefined
- libphonenumber: ([homepage](https://github.com/google/libphonenumber/)) made in c++
...
- cloud-custodian: ([homepage](https://github.com/cloud-custodian/cloud-custodian)) made in python
- javaparser: ([homepage](https://javaparser.org)) made in jvm
- orbit: ([homepage](https://github.com/google/orbit)) made in c++
- dropbear: ([homepage](https://matt.ucc.asn.au/dropbear/dropbear.html)) made in c++
- libldac: ([homepage](https://android.googlesource.com/platform/external/libldac)) made in c++
- importlib_metadata: ([homepage](https://github.com/python/importlib_metadata)) made in python
...
- checker-framework: ([homepage](https://github.com/typetools/checker-framework)) made in jvm
- retrofit: ([homepage](https://square.github.io/retrofit/)) made in jvm
- pdfminersix: ([homepage](https://pdfminersix.readthedocs.io/en/latest/)) made in python
- gnutls: ([homepage](https://www.gnutls.org)) made in c++
- grpc-gateway: ([homepage](https://github.com/grpc-ecosystem/grpc-gateway)) made in go
- curl: ([homepage](https://curl.haxx.se/)) made in c++
- mp4parse-rust: ([homepage](https://github.com/mozilla/mp4parse-rust)) made in rust
...
- protobuf-js: ([homepage](https://github.com/protobufjs/protobuf.js)) made in javascript
...
- jackson-dataformats-text: ([homepage](https://github.com/FasterXML/jackson-dataformats-text)) made in jvm
- sqlalchemy-utils: ([homepage](https://github.com/kvesteri/sqlalchemy-utils)) made in python
- numpy: ([homepage](numpy.org)) made in python
- networkx: ([homepage](https://github.com/networkx/networkx)) made in python
- jackson-core: ([homepage](https://github.com/FasterXML/jackson-core)) made in jvm
...
- catapult: ([homepage](https://github.com/nemtech/catapult-server)) made in undefined
- smart_open: ([homepage](https://github.com/RaRe-Technologies/smart_open)) made in python
...
- gitpython: ([homepage](https://github.com/gitpython-developers/gitpython)) made in python
- libspectre: ([homepage](https://www.freedesktop.org/wiki/Software/libspectre/)) made in c++
...
- fast-xml-parser: ([homepage](https://naturalintelligence.github.io/fast-xml-parser/)) made in javascript
...
- libiec61850: ([homepage](https://github.com/mz-automation/libiec61850)) made in c
...
- ecdsa-python: ([homepage](https://github.com/starkbank/ecdsa-python)) made in python
...
- sqlalchemy_jsonfield: ([homepage](https://github.com/penguinolog/sqlalchemy_jsonfield)) made in python
- libevent: ([homepage](https://github.com/libevent/libevent)) made in c++
- soupsieve: ([homepage](https://github.com/facelessuser/soupsieve)) made in python
...
- sketches-core: ([homepage](https://github.com/DataSketches/sketches-core)) made in jvm
- knative: ([homepage](https://knative.dev/)) made in go
- apache-commons-io: ([homepage](https://commons.apache.org/proper/commons-io/)) made in jvm
...
- netty-tcnative: ([homepage](https://netty.io/wiki/forked-tomcat-native.html)) made in jvm
- multidict: ([homepage](https://github.com/aio-libs/multidict)) made in python
- php: ([homepage](http://php.net/)) made in c++
- spring-cloud-stream: ([homepage](https://github.com/spring-projects/spring-data-mongodb)) made in jvm
...
- python-email-validator: ([homepage](https://github.com/JoshData/python-email-validator)) made in python
- go-coredns: ([homepage](https://coredns.io)) made in go
- apache-commons-collections: ([homepage](https://commons.apache.org/proper/commons-collections/)) made in jvm
...
- serde_urlencoded: ([homepage](https://github.com/nox/serde_urlencoded)) made in rust
...
- joda-convert: ([homepage](https://github.com/JodaOrg/joda-convert)) made in jvm
...
- looker-sdk: ([homepage](https://github.com/looker-open-source/sdk-codegen)) made in python
...
- spring-data-jpa: ([homepage](https://github.com/spring-projects/spring-data-jpa.git)) made in jvm
- janus-gateway: ([homepage](https://github.com/meetecho/janus-gateway)) made in c++
...
- jsonpickle: ([homepage](https://github.com/jsonpickle/jsonpickle)) made in python
- h2database: ([homepage](https://h2database.com/)) made in jvm
- python-multipart: ([homepage](https://github.com/Kludex/python-multipart)) made in python
- libxlsxwriter: ([homepage](http://libxlsxwriter.github.io)) made in c
- skia: ([homepage](https://github.com/google/skia)) made in c++
- ngolo-fuzzing: ([homepage]('https://github.com/catenacyber/ngolo-fuzzing)) made in go
...
- python3-openid: ([homepage](https://github.com/necaris/python3-openid)) made in python
- linkerd2: ([homepage](https://linkerd.io/)) made in go
- lodash: ([homepage](https://lodash.com/)) made in javascript
- validators: ([homepage](https://github.com/python-validators/validators)) made in python
- ms-tpm-20-ref: ([homepage](https://github.com/microsoft/ms-tpm-20-ref)) made in c
- poco: ([homepage](https://github.com/pocoproject/poco)) made in c++
- oauth2: ([homepage](https://github.com/googleapis/oauth2client)) made in python
...
- ibmswtpm2: ([homepage](https://sourceforge.net/projects/ibmswtpm2/)) made in c++
...
- azure-sdk-for-python: ([homepage](https://github.com/azure/azure-sdk-for-python)) made in python
- aiohttp: ([homepage](https://github.com/aio-libs/aiohttp)) made in python
- g-api-py-oauthlib: ([homepage](https://github.com/googleapis/google-auth-library-python-oauthlib)) made in python
- spring-data-redis: ([homepage](https://github.com/spring-projects/spring-boot)) made in jvm
- wasmtime: ([homepage](https://wasmtime.dev/)) made in rust
- nginx: ([homepage](http://nginx.org)) made in c
- tpm2: ([homepage](https://chromium.googlesource.com/chromiumos/third_party/tpm2)) made in c++
- go-sqlite3: ([homepage](http://mattn.github.io/go-sqlite3/)) made in go
- lighttpd: ([homepage](https://www.lighttpd.net/)) made in c
- spring-webflow: ([homepage](https://github.com/spring-projects/spring-webflow.git)) made in jvm
- digest: ([homepage](https://github.com/bmc/digest)) made in python
- msgpack-python: ([homepage](https://github.com/msgpack/msgpack-python)) made in python
- libigl: ([homepage](https://libigl.github.io)) made in c++
- flask-jwt-extended: ([homepage](https://github.com/vimalloc/flask-jwt-extended)) made in python
- strongswan: ([homepage](https://www.strongswan.org)) made in c++
- glslang: ([homepage](https://github.com/khronosgroup/glslang)) made in c++
- java-example: ([homepage](https://github.com/CodeIntelligenceTesting/jazzer)) made in jvm
...
- apache-commons-lang: ([homepage](https://github.com/apache/commons-lang)) made in jvm
- evo-inflector: ([homepage](https://github.com/atteo/evo-inflector)) made in jvm
...
- qcms: ([homepage](https://hg.mozilla.org/mozilla-central/file/tip/gfx/qcms/)) made in rust
...
- scorecard-web: ([homepage](https://github.com/ossf/scorecard-webapp)) made in go
- ipython: ([homepage](ipython.readthedocs.org)) made in python
- fastjson2: ([homepage](https://github.com/alibaba/fastjson2)) made in jvm
- apache-commons-beanutils: ([homepage](https://commons.apache.org/proper/commons-beanutils/)) made in jvm
...
- rust-lexical: ([homepage](https://github.com/Alexhuszagh/rust-lexical)) made in rust
...
- mongo-go-driver: ([homepage](https://github.com/mongodb/mongo-go-driver)) made in go
...
- libaom: ([homepage](https://aomedia.org/av1-features/get-started/)) made in c++
...
- jupyter-nbconvert: ([homepage](https://github.com/jupyter/nbconvert)) made in python
...
- tensorflow-addons: ([homepage](https://github.com/tensorflow/addons)) made in python
- open62541: ([homepage](https://open62541.org/)) made in c++
- json-flattener: ([homepage](https://github.com/wnameless/json-flattener/)) made in jvm
...
- exprtk: ([homepage](https://www.partow.net/programming/exprtk/index.html)) made in c++
- uritemplate: ([homepage](https://github.com/python-hyper/uritemplate)) made in python
- requests: ([homepage](https://requests.readthedocs.io/en/master/)) made in python
...
- spotify-json: ([homepage](https://github.com/spotify/spotify-json)) made in c++
- ujson: ([homepage](https://github.com/ultrajson/ultrajson)) made in python
- ua-parser-js: ([homepage](https://github.com/faisalman/ua-parser-js)) made in javascript
- sentencepiece: ([homepage](https://github.com/google/sentencepiece)) made in c++
...
- java-diff-utils: ([homepage](https://github.com/java-diff-utils/java-diff-utils.git)) made in jvm
...
- python-prompt-toolkit: ([homepage](https://github.com/prompt-toolkit/python-prompt-toolkit)) made in python
- ecc-diff-fuzzer: ([homepage](https://github.com/catenacyber/elliptic-curve-differential-fuzzer)) made in c++
...
- g-http-java-client: ([homepage](https://github.com/googleapis/google-http-java-client/)) made in jvm
- gwt: ([homepage](https://www.gwtproject.org/)) made in jvm
- pydateutil: ([homepage](https://dateutil.readthedocs.io/en/stable/)) made in python
...
- pyasn1-modules: ([homepage](https://github.com/pyasn1/pyasn1-modules)) made in python
- lodepng: ([homepage](https://github.com/lvandeve/lodepng)) made in c++
- gcp-python-cloud-storage: ([homepage](https://github.com/googleapis/python-storage)) made in python
...
- plexus-utils: ([homepage](https://github.com/codehaus-plexus/plexus-utils)) made in jvm
...
- nimbus-jwt: ([homepage](https://connect2id.com/products/nimbus-jose-jwt)) made in jvm
...
- g-oauth-java-client: ([homepage](https://github.com/googleapis/google-oauth-java-client)) made in jvm
- jdom: ([homepage](http://jdom.org/)) made in jvm
- flask-restx: ([homepage](https://github.com/python-restx/flask-restx)) made in python
- apache-commons-codec: ([homepage](https://commons.apache.org/proper/commons-codec/)) made in jvm
...
- itsdangerous: ([homepage](https://github.com/pallets/itsdangerous)) made in python
...
- websocket-client: ([homepage](https://github.com/websocket-client/websocket-client)) made in python
...
- connexion: ([homepage](https://github.com/spec-first/connexion)) made in python
...
- parsimonious: ([homepage](https://github.com/erikrose/parsimonious)) made in python
...
- vulnerable-project: ([homepage](https://github.com/google/oss-fuzz)) made in c++
- apache-commons-csv: ([homepage](https://github.com/apache/commons-csv)) made in jvm
...
- ja3: ([homepage](https://engineering.salesforce.com/tls-fingerprinting-with-ja3-and-ja3s-247362855967/)) made in python
- snakeyaml: ([homepage](https://bitbucket.org/snakeyaml/snakeyaml/src/master/)) made in jvm
- llamacpp: ([homepage](https://github.com/ggerganov/llama.cpp)) made in c++
- jmespathpy: ([homepage](https://github.com/jmespath/jmespath.py)) made in python
...
- httpcomponents-core: ([homepage](https://github.com/apache/httpcomponents-core)) made in jvm
- spring-integration: ([homepage](https://spring.io/projects/spring-integration)) made in jvm
- libvnc: ([homepage](https://libvnc.github.io/)) made in c++
- cppitertools: ([homepage](https://github.com/ryanhaining/cppitertools)) made in c++
- golang: ([homepage](https://golang.org/)) made in go
- opt_einsum: ([homepage](https://github.com/dgasmith/opt_einsum)) made in python
