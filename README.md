...
- ntpsec: ([homepage](https://ntpsec.org/)) made in c
...
- jmespathpy: ([homepage](https://github.com/jmespath/jmespath.py)) made in
  python
- wolfssh: ([homepage](https://www.wolfssl.com/wolfssh/)) made in c
- adal:
...
- tcpreplay: ([homepage](https://tcpreplay.appneta.com/)) made in c
...
- kfilemetadata:
  ([homepage](https://invent.kde.org/frameworks/kfilemetadata.git)) made in c++
...
- wolftpm: ([homepage](https://github.com/wolfSSL/wolfTPM)) made in c
